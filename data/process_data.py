...
def load_data(messages_filepath, categories_filepath):
    ...
    messages_filepath : string
        Filepath of messages.
    categories_filepath : string
        Filepath of categories.
...
def clean_data(df):
    '''
    Cleans the data and convert sigle column information to a set of columns.
...
def save_data(df, database_filename):
    ...
    ----------
    df : DataFrame
        Clean DataFrame to load in the database.
    database_filename : string
        Name of the SQLite file to store.
